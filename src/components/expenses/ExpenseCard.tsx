...
export function ExpenseCard({
  ...
  const targetLink = expense.target_type === 'event'
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {!compact && expense.memo && (
              <p className="text-sm text-sepia truncate mt-1">
                {expense.memo}
              </p>
            )}

            {/* Meta info: date and target */}
            <div className="flex flex-wrap items-center gap-3 mt-2 text-sm text-sepia">
              ...
              >
                ...
                <span className="truncate max-w-[200px]">{expense.target_name}</span>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <span className="font-serif text-lg font-semibold tabular-nums text-wood-dark">
            ...
            {/* Action buttons */}
            {(onEdit || onDelete) && (
              <div className="flex items-center gap-2 border-l border-wood-medium/20 pl-4">
                {onEdit && (
                  <button
