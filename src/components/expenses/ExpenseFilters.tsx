  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex items-center gap-2 text-sepia shrink-0">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        {/* Date range */}
        <div className="flex items-center gap-2">
          <label htmlFor="filter-date-start" className="text-sm text-sepia shrink-0">
            From:
          </label>
          <input
            type="date"
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="filter-date-end" className="text-sm text-sepia shrink-0">
            To:
          </label>
          <input
            type="date"
...
export function ExpenseFilterPills({
  ...
  if (filters.source_type !== 'all') {
    pills.push({ label: `Source: ${sourceTypeLabels[filters.source_type]}`, field: 'source_type' });
  }
